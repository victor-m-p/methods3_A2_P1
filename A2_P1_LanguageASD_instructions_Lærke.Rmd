...
quadratic_m1 <- lm(CHI_MLU ~ VISIT*Diagnosis*VISIT2, df)
quadratic_m21 <- lm(CHI_MLU ~ VISIT*Diagnosis + VISIT2, df)
quadratic_m22 <- lm(CHI_MLU ~ VISIT*Diagnosis + I(VISIT^2), df)
quadratic_m3 <- lm(CHI_MLU ~ VISIT + Diagnosis*VISIT2, df)
quadratic_m4 <- lm(CHI_MLU ~ VISIT + Diagnosis + VISIT2, df)
quadratic_m52 <- lm(CHI_MLU ~ VISIT + VISIT2 + Diagnosis + VISIT:Diagnosis, df)
quadratic_m51 <- lm(CHI_MLU ~ VISIT + VISIT2 + Diagnosis + VISIT*Diagnosis, df)
quadratic_m6 <- lm(CHI_MLU ~ poly(VISIT,2, raw = T):Diagnosis, df)

summary(quadratic_m21)
summary(quadratic_m22)
summary(quadratic_m3)
summary(quadratic_m4)
summary(quadratic_m51)
summary(quadratic_m52)
summary(quadratic_m6)

cubic_m1 <- lm(CHI_MLU ~ VISIT*Diagnosis*VISIT3, df)
cubic_m2 <- lm(CHI_MLU ~ VISIT*Diagnosis + VISIT3, df)
cubic_m3 <- lm(CHI_MLU ~ VISIT + Diagnosis * VISIT3, df)
cubic_m4 <- lm(CHI_MLU ~ VISIT + Diagnosis + VISIT3, df)
cubic_m5 <- lm(CHI_MLU ~ VISIT + VISIT3 + Diagnosis + VISIT*Diagnosis, df)
...
anova(linear_m2, quadratic_m6, cubic_m5)

pacman::p_load(MuMIn, tidyverse)

#writing AIC values down
m_aic <- AIC(linear_m2, quadratic_m6, cubic_m5)
...
m_bic <- BIC(linear_m2, quadratic_m6, cubic_m5)
