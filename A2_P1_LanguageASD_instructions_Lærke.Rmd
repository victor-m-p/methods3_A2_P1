...
quadratic_m1 <- lm(CHI_MLU ~ VISIT + VISIT2 + Diagnosis + VISIT*Diagnosis, df)
quadratic_m2 <- lm(CHI_MLU ~ poly(VISIT,2, raw = T):Diagnosis, df)
...
cubic_m1 <- lm(CHI_MLU ~ VISIT + VISIT3 + Diagnosis + VISIT*Diagnosis, df)
cubic_m2 <- lm(CHI_MLU ~ poly(VISIT,3, raw = T):Diagnosis, df)
...
anova(linear_m1, quadratic_m1, cubic_m1)

pacman::p_load(MuMIn, tidyverse)

#writing AIC values down
m_aic <- AIC(linear_m1, quadratic_m1, cubic_m1)
...
m_bic <- BIC(linear_m1, quadratic_m1, cubic_m1)
